        ...
        <div class="div col col-sm-12 col-12 col-md-5 col-lg-3 col-xl-3 d-flex">
            <div class="card navyCard flex-fill">
                ...
                <div class="card-body navyCardBody d-flex flex-column">
                    ...
                    <p class="card-text navyCardText"><strong>Buy your tickets here -> <a href="https://necretfundraisers.ie" target="_blank">https://necretfundraisers.ie</a></strong>  </p>
                    <p class="card-text navyCardText">Every ticket sold helps support NECRET’s vital work in cancer research and care here in the North East.</p>
                    <h5>Tickets</h5>
