<div id="news" class="section-5 container-fluid">
    ...
    <div class="row text-center">
        ...
        <div class="div col col-sm-12 col-12 col-md-5 col-lg-3 col-xl-3 d-flex">
            <div class="card navyCard flex-fill">
                ...
                <div class="card-body navyCardBody d-flex flex-column">
                    ...
                    <a href="https://www.facebook.com/events/803079673796819/" target="_blank" class="mt-auto btn btn-primary btn-upcoming"><i class="fa fa-walking"></i> Read More</a>
                </div>
            </div>
        </div>
        ...
        <div class="div col col-sm-12 col-12 col-md-5 col-lg-3 col-xl-3 d-flex">
            <div class="card navyCard flex-fill">
                <img class="card-img-top" src="../../img/dip.jpg" alt="dipNNip">
                <div class="card-body navyCardBody d-flex flex-column">
                    ...
                    <a href="https://www.facebook.com/events/995468774258198/" target="_blank" class="mt-auto btn btn-primary btn-blankets"><i class="fa fa-swimmer"></i> Read More</a>                    </div>
            </div>
        </div>
    </div>
</div>